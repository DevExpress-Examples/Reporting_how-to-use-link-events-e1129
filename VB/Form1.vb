...
Namespace UseLinkEvents
	Partial Public Class Form1
		...
		Private backgColor As Color = Color.LightGreen
		Private foregColor As Color = Color.Green

		' Create the Marginal Header section.
		Private Sub link1_CreateMarginalHeaderArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) _
                                Handles link1.CreateMarginalHeaderArea
		...
		Private Sub link1_CreateDetailHeaderArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) _
			...
			e.Graph.BackColor = backgColor
			e.Graph.ForeColor = foregColor
		...
		Private Sub link1_CreateDetailArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) _
                                Handles link1.CreateDetailArea
			' Create a new rectangle.
			Dim r As New Rectangle(0, 0, 150, 50)
			Dim top As Integer = r.Top
			...
			' Draw a text brick with "Good-bye!".
                                                top = top + 50
			e.Graph.DrawString("Good-bye!", Color.Blue, New Rectangle(0, top, 150, 50), BorderSide.All)
			...
			e.Graph.DrawRect(New Rectangle(200, top, 50, 50), BorderSide.All, Color.Lavender, e.Graph.BorderColor)

			' Draw an image brick.
			Dim img As Bitmap = CType(Bitmap.FromFile("..\..\fish.bmp"), Bitmap)
			img.MakeTransparent()
			e.Graph.DrawImage(img, New Rectangle(200 + (50 - img.Width) / 2, top + (50 - img.Height) / 2, img.Width, img.Height), _
                                                BorderSide.None, Color.Transparent)
		End Sub

		' Create the Marginal Footer section.
		Private Sub link1_CreateDetailFooterArea(ByVal sender As Object, ByVal e As DevExpress.XtraPrinting.CreateAreaEventArgs) _
                                Handles link1.CreateDetailFooterArea
			' Set the background color to Coral.
			backgColor = Color.Coral
